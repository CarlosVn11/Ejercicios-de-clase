...
//*************	 Visual Studio 2017					         ****//
//*************  Ejercicio de clase 12: Carro en diagonal    ***//
//*************  Fecha: 02/11/2018                          **//
//***********************************************************//
...
void animacion()
{
	...
	if(circuito) //bandera de circuito
	{
		...
		{
			rotKit = -140.0; //rotacion para el carro
			movKitZ -=2.0; //formar una diagonal
			movKitX -= 0.8; //formar una diagona
			if(movKitX<=0) //para cambiar de estado
			{
				recorrido3 = false;
				recorrido5 = true; //Cambio bandera para pasar al estado E
			}
		}
