...
//*************	 Visual Studio 2017					   ******//
//*************  Ejercicio de clase 8: Mesa de ajedrez   ***//
//*************  Fecha: 12/10/2018                       **//
//********************************************************//
#include "texture.h"
...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	t_fractal.LoadTGA("fractal2.tga");
	t_fractal.BuildGLTexture();
	t_fractal.ReleaseImage();
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glTranslatef(pos_camX, pos_camY, pos_camZ);
		...
		/*Cara con texturizado de ajedrez*/
		...
		glPushMatrix();
			...
			prisma(t_fractal.GLindex, t_fractal.GLindex);
		glPopMatrix();
