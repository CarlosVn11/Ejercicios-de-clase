...
//*************	 Visual Studio 2017					         ****//
//*************  Ejercicio de clase 11: Coreografia          ***//
//*************  Fecha: 26/10/2018                          **//
//***********************************************************//
...
void keyboard ( unsigned char key, int x, int y )  // Create Keyboard Function
{
	...
	case 'Q': //mueve pierna y rodilla derecha
		rotRodPiernaDer++;
		rotRodDer--;
		break;
	...
	case 'C': //Mueve pierna izquierda hacia abajo con rodilla izquierda
		rotRodPiernaIzq++;
		rotRodIzq--;
	break;
		
	case 'c': //Mueve pierna izquierda hacia arriba con rodilla izquierda
		rotRodPiernaIzq--;
		rotRodIzq+=0.9;
	break;

	case 'U': //mueve la cabeza hacia la izquierda
		rotCabeza++;
	break;

	case 'u': //mueve la cabeza hacia la derecha
		rotCabeza--;
	break;


	case 'N': //mueve la cabeza hacia adelante
		rotCuello++;
		break;

	case 'n': //mueve la cabeza hacia atras
		rotCuello--;
		break;

	case 'M': //Mueve los brazos hacia arriba
		rotBD++;
		rotBI++;
		rotRodPiernaIzq--;
		rotRodIzq += 0.9;
	...
	case 'm': //mueve los brazos hacia abajo
		rotBD--;
		rotBI--;
		rotRodPiernaIzq++;
		rotRodIzq--;
